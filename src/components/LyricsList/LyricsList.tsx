...
const LyricsList = () => {
    ...
    console.log(Lyrics);
    useEffect(() => {
        fetch(`https://cors-anywhere.herokuapp.com/https://api.musixmatch.com/ws/1.1/chart.tracks.get?chart_name=top&page=1&page_size=10&country=us&f_has_lyrics=1&apikey=237d5d86270eff9d001af5d3e4a2364b`)
            .then(res => res.json())
